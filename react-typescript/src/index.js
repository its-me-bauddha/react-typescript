...
(function (ExpressionValues) {
    ExpressionValues[ExpressionValues["A"] = 10] = "A";
    ExpressionValues[ExpressionValues["B"] = 20] = "B";
    ExpressionValues[ExpressionValues["C"] = 30] = "C";
})(ExpressionValues || (ExpressionValues = {}));
console.log("Addition  :".concat(ExpressionValues.C));
